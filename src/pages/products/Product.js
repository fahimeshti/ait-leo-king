...
const Product = () => {
  return (
    ...
    <section className="mt-10 w-[85%] mx-auto ">
      {/* product top banner */}
      <div className="flex h-[32vw] xm:h-[28vw] sm:h-[24vw] md:h-[19rem]">
      ...
      <div>
        ...
        <div className="grid grid-flow-row grid-cols-1 md:grid-cols-7 gap-8 mt-10 mb-10">
          {/* filter by */}
          <div className="md:col-span-2">
            <div className="flex w-full">
            <h3 className="text-xl lg:text-2xl text-[#00ade5] font-bold">
              FILTER
            </h3>
            <h3 className="text-xl lg:text-2xl text-[#00ade5] font-bold ml-2">BY</h3>
          ...
          <div className="md:col-span-5">
            ...
            <div className="grid grid-flow-row grid-cols-1 xm:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
                {
                    data.map(item => <ProductMapData item={item} />)
                }
            </div>

            <div className="w-full border-b border-[#00ade5] mt-10"></div>
            <button className="text-gray-500 border rounded-full py-2 px-4  text-sm mt-5 hover:text-white hover:bg-black hover:border-none transition-all">LOAD MORE</button>
          </div>
        </div>
      </div>
    </section>
